...
const LeagueAssists = ({ leagueId, season }) => {
  ...
  if (!topAssists.length) {
    return (
      <p className={styles.leagueAssistsNoData}>
            ...
            <tr key={assist.player.id}>
              <td className={styles.leagueAssistsPlayerRow}>
                <div className={styles.leagueAssistsPlayerInfo}>
                  <span className={styles.leagueAssistsPlayerRank}>
                    {index + 1}.
                  </span>
                  <Link to={`/players/${assist.player.id}`}>
                    <img
                      ...
                      className={styles.leagueAssistsPlayerPhoto}
                    />
                    <span className={styles.leagueAssistsPlayerName}>
                      {assist.player.name}
                    </span>
                  </Link>
                  <Link to={`/team/${assist.statistics[0].team.id}`}>
                    <img
                      ...
                      alt={assist.statistics[0].team.name}
                      className={styles.leagueAssistsTeamLogo}
                    />
                    <span className={styles.leagueAssistsTeamName}>
                      {assist.statistics[0].team.name}
                    </span>
                  </Link>
                </div>
              </td>
              <td className={styles.leagueAssistsAssists}>
