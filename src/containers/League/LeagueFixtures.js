  ...
  return (
    <div className={styles.fixturesContainer}>
      ...
      >
        ...
        {[...new Set(fixtures.map((fixture) => fixture.league.round))].map(
          (round) => (
        ...
        {filteredFixtures.map((fixture, index) => (
          <div key={index} className={styles.fixtureItem}>
            ...
            <div className={styles.fixtureTeamsContainer}>
              <div
                className={`${styles.fixtureItemTeam} ${styles.fixtureItemTeamLeft}`}
              >
              ...
              <div
                className={`${styles.fixtureItemTeam} ${styles.fixtureItemTeamRight}`}
              >
